...
<ul class="hoauthSNList">
	...
	foreach($sns as $sn)
	{
		...
		echo '<li>' . CHtml::link($provider, $profileUrl, array('target' => '_blank')) . ' ' . CHtml::ajaxLink('(' . HOAuthAction::t('Remove') . ')', $deleteUrl, array(
			...
			'beforeSend' => new CJavaScriptExpression("function() {return confirm('" . HOAuthAction::t('If you remove this social network account, you will you will not be able to login with it.\\n\\nDo you realy want to remove this account?') . "');}"),
